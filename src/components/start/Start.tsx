            ...
            <div className=' flex items-center justify-between '>
                ...
                <div className=' w-[40%] flex items-center justify-between '>
                        ...
                        <div className="relative w-full ">
                            ...
                            <button type="submit" className="text-white absolute right-0 bottom-0 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ">Найти</button>
                        </div>
                        <Link  to={"/add"}>
